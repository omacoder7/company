...
<div class="case-section-block" data-section data-section-index="{{ $index }}">
    ...
    <div class="form-group">
        ...
        <p class="case-section-hint">
            Если загрузить файл, он будет показан в этом блоке кейса на странице.
            Изображение этого блока автоматически используется в блоках с тем же номером во всех языках,
            если в других языках для этого блока не загружено своё изображение.
        </p>
    </div>

...
<div class="form-group">
    ...
    <p class="case-section-hint">
        Изображения контентных блоков общие для всех языков: если вы загрузили картинку в блок в одном языке,
        она автоматически подставится в блок с тем же номером в других языках (если там не выбрано своё изображение).
    </p>
</div>
